...
{% include question_numerical.html
    ...
    correct_answer="0.49"
    tolerance="0.005"
    solution_text="$P(\text{internet | economy)}=\frac{140}{285}=\frac{28}{57}=0.49$"
%}
...
{% include question_multiple_choice.html
    ...
    options="a::$P(\text{internet}) = P(\text{internet | economy)$, so not independent||b::$P(\text{internet}) = P(\text{internet | economy)$, so independent||c::$P(\text{internet}) \neq P(\text{internet | economy)$, so not independent||d::$P(\text{internet}) \neq P(\text{internet | economy)$, so independent"
    correct_answer="c"
    solution_text="$P(\text{internet}) \neq P(\text{internet | economy)$ implies not independent, and here we have P(internet) = 0.47, P(intenet | economy) = 0.49"
%}
...
{% include question_numerical.html
    ...
    correct_answer="0.75"
    tolerance="0.005"
    solution_text="$P(\text{not travel agent | first class})=\frac{45+25}{93}=\frac{70}{93}=0.75$"
%}
...
{% include question_numerical.html
    ...
    correct_answer="0.52"
    tolerance="0.00005"
    solution_text="P(departs on time AND arrives on time) <br> = P(departs on time) × P(arrives on time|departs on time) <br> P(departs on time AND arrives on time) = 0.65 × 0.8 = 0.52"
%}
...
{% include question_numerical.html
    ...
    tolerance="0.00005"
    solution_text="$P(\text{departed on time | arrived on time}) = \frac{0.52}{0.6075}=0.856$"
%}
